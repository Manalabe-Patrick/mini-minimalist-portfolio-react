          ...
          >
            ...
            <div className="flex justify-center lg:block">
              <p className="text-customSecondary text-center flex my-4">
                <Mail className="mr-2" /> <span>manalabepatrick@gmail.com</span>
              </p>
            </div>
            <div className="flex justify-center lg:block">
              <p className="text-customSecondary text-center flex my-4">
                <Phone className="mr-2" /> <span>+6309666927694</span>
              </p>
            </div>
            <div className="flex justify-center lg:block">
              <p className="text-customSecondary text-center flex my-4">
                <MapPin className="mr-2" />
                <span>New Cabalan, Olongapo City, Zamblaes, Philippines</span>
              </p>
            </div>
          </motion.div>
        </div>
